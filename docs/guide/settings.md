...
| **Show release notes on update**   | Minor & major only                                   | Shows a post-update modal with release notes for any versions you missed, plus a thank-you/funding note. **All updates** shows it for every bump including patches; **Never** disables it. Never shown on white-labeled installs, regardless of this setting. |
